...
def sender(request):
	...
	parser.add_argument('-n', default=5, type=int, help=' the number of packets that the sender will send. In case the server does not receive an ACK from the receiver should re-send the same packet. This counts as one packet')
