...
for i in range(amount_of_nodes):
            os.system(f'docker run --network="host"  --name container_{i} --cap-add=NET_ADMIN -u root -v /home/tobias/networkscanner:/mnt n sudo python job_processor.py container_{i} &')
